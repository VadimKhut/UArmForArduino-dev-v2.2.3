...
#define DEFAULT_ANGLE			60
	...
	#define MATH_PI 			3.141592653589793238463
	#define MATH_TRANS  		57.2958    
	#define MATH_L1 			107.45	// 10CM Shadow of OA on coordinate axis +Z
	#define MATH_L2 			21.17	// AF = 2CM Shadow of OA on coordinate axis +Y
	#define MATH_LOWER_ARM 		148.25	// Length of Lower_ArmLink2
	#define MATH_UPPER_ARM 		160.2 	// Length of Upper_ArmLink1
	#define MATH_FRONT_HEADER 	25.00	// the distance between wrist to the front point we use (CE)
	#define MATH_UPPER_LOWER 	MATH_UPPER_ARM/MATH_LOWER_ARM
	#define MAX_Z				260		// max height, Max Z = OA + AB -DE 
	#define MIN_Z				(-120)  // Min Z = BC - DE - OA
#endif
